...
<!-- Mirrored from transvelo.github.io/electro-html/2.0/html/home/index.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 12 Jun 2022 09:14:42 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=utf-8" /><!-- /Added by HTTrack -->
<head>
        <!-- Title -->
        <title>My Smile Shop</title>
                    ...
                    <div class="container">
                        <div class="d-flex align-items-center">
                            <div class="topbar-left">
                                <a href="#" class="text-gray-110 font-size-13 hover-on-dark">Welcome to My Smile Shop</a>
                            </div>
                            <div class="topbar-right ml-auto">
                                <ul class="list-inline mb-0">
                                    <li class="list-inline-item mr-0 u-header-topbar__nav-item u-header-topbar__nav-item-border">
                                        <a href="contact-v2.php" class="u-header-topbar__nav-link"><i class="ec ec-map-pointer mr-1"></i> Store Locator</a>
                                    </li>
                                    <li class="list-inline-item mr-0 u-header-topbar__nav-item u-header-topbar__nav-item-border">
                                        <a href="https://transvelo.github.io/electro-html/2.0/html/shop/track-your-order.php" class="u-header-topbar__nav-link"><i class="ec ec-transport mr-1"></i> Track Your Order</a>
                                    </li>
                            ...
                            <div class="col-auto">
                                ...
                                <nav class="navbar navbar-expand u-header__navbar py-0 justify-content-xl-between max-width-270 min-width-270">
                                    ...
                                    <a class="order-1 order-xl-0 navbar-brand u-header__navbar-brand u-header__navbar-brand-center" href="index.php" aria-label="Electro">
                                        <img src="assets/img/Logo/My Smile Logo.png" alt="">
                                    </a>
                                    <!-- End Logo -->
                                        ...
                                        <li class="col pr-xl-0 px-2 px-sm-3 d-none d-xl-block">
                                            ...
                                            <div id="basicDropdownHover" class="cart-dropdown dropdown-menu dropdown-unfold border-top border-top-primary mt-3 border-width-2 border-left-0 border-right-0 border-bottom-0 left-auto right-0" aria-labelledby="basicDropdownHoverInvoker">
                                                ...
                                                <div class="flex-center-between px-4 pt-2">
                                                    <a href="https://transvelo.github.io/electro-html/2.0/html/shop/cart.php" class="btn btn-soft-secondary mb-3 mb-md-0 font-weight-normal px-5 px-md-4 px-lg-5">View cart</a>
                                                    <a href="checkout.php" class="btn btn-primary-dark-w ml-md-2 px-5 px-md-4 px-lg-5">Checkout</a>
                                                </div>
                                            </div>
                                        </li>
                                    </ul>
                                                            ...
                                                            <li class="nav-item hs-has-sub-menu u-header__nav-item"
                                                                ...
                                                                <ul id="homeSubMenu" class="hs-sub-menu u-header__sub-menu animated hs-position-left fadeOut" aria-labelledby="homeMegaMenu" style="min-width: 230px; display: none;">
                                                                    ...
                                                                    <li class="hs-has-sub-menu">
                                                                        <a class="nav-link u-header__sub-menu-nav-link " href="index.php">Home-v1</a>
                                                                    </li>
                                                                    <!-- End Home-v1 -->

                                                                    <!-- Home-v2 -->
                                                                    <li class="hs-has-sub-menu">
                                                                        <a class="nav-link u-header__sub-menu-nav-link " href="home-v2.php">Home-v2</a>
                                                                    </li>
                                                                    <!-- End Home-v2 -->

                                                                    <!-- Home-v3 -->
                                                                    <li class="hs-has-sub-menu">
                                                                        <a class="nav-link u-header__sub-menu-nav-link " href="home-v3.php">Home-v3</a>
                                                                    </li>
                                                                    <!-- End Home-v3 -->

                                                                    <!-- Home-v4 -->
                                                                    <li class="hs-has-sub-menu">
                                                                        <a class="nav-link u-header__sub-menu-nav-link " href="home-v4.php">Home-v4</a>
                                                                    </li>
                                                                    <!-- End Home-v4 -->
                                                                </ul>
                                                                <!-- End Home - Submenu -->
                                                ...
                                                <div class="row u-header__mega-menu-wrapper">
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <ul class="u-header__sub-menu-nav-group">
                                                            ...
                                                            <li><a href="checkout.php" class="nav-link u-header__sub-menu-nav-link">Checkout</a></li>
